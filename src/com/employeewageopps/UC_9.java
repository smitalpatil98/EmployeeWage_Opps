...
public class UC_9 {
    ...
    public UC_9(String company, int EMP_RATE_PER_HOUR, int EMP_WORK_DAYS, int EMP_WORK_HOUR) {
    ...
    public static void main(String[] args) {
        ...
        UC_9 emp1 = new UC_9("Nokia", 400, 25, 150);
        emp1.calculateEmployeeWage();
        System.out.println(emp1);

        UC_9 emp2 = new UC_9("Apple", 600, 27, 162);
